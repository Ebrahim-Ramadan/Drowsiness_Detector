...
class DrowsinessDetector:
    def __init__(self, master):
        ...
        self.start_button = ctk.CTkButton(self.master, text="Start", command=lambda: (self.start_detection(), self.detect_drowsiness()))
        self.start_button.grid(row=1, column=0, padx=10, pady=10, sticky='w')

        self.stop_button = ctk.CTkButton(self.master, text="Stop", command=self.stop_detection)
        ...
        if self.is_running==True:
            ...
            for (x,y,w,h) in left_eye:
                ...
                if(score>15):
                    ...
                    self.detect_drowsiness() # call the detect_drowsiness method here
